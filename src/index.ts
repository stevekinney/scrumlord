...
export const archiveTask = taskCommandsModule.archiveTask;
...
export const clearTaskParent = taskCommandsModule.clearTaskParent;
...
export const restoreTask = taskCommandsModule.restoreTask;
...
export const setTaskParent = taskCommandsModule.setTaskParent;
