...
| 5, 6a, 6b, 6c             | B-2              | merged                                                                                                           | c6a2d34   | `wrong-task-pr`, `footer-missing`, `footer-repair` |
| 20, 21, 22, 26, 27        | C                | merged                                                                                                           | b627a3d   | `no-commits`, `worktree-cleanup`                   |
| 7, 25                     | D                | merged                                                                                                           | 754978e   | `bot-pending-advisory`, `bot-pending-strict`       |
| 9                         | F                | merged                                                                                                           | 4537a91   | `once-three-tasks`                                 |
| 13, 19                    | B-3              | merged                                                                                                           | 9cf9ce1   | covered by `pipeline-recovery.test.ts` unit tests  |
| 3, 18                     | E                | in progress                                                                                                      | (this PR) | `phase-split`                                      |
